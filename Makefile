...
dump:
	rm -f -r ./src/svg/
	mkdir ./src/svg/
	#font-dump.js -c config.yml -f -i ./src/original/mfglabsiconset-webfont.svg -o ./src/svg/ -d diff.yml
	${BIN}/svg-font-dump -c `pwd`/config.yml -f -i ./src/original/mfglabsiconset-webfont.svg -o ./src/svg/ -d diff.yml
